...
import { ArrowRightIcon, ClockIcon, Recycle } from "lucide-react";
...
//               className={`h-8 w-8 rounded border border-primary/60 text-xs cursor-pointer
//               ${
//                 selectedSeats.includes(seatId)
//                   ? "bg-primary text-white"
//                   : ""
...
//               className={`flex items-center gap-2 px-6 py-2 cursor-pointer rounded-r-md
//               ${
