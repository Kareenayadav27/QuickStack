...
const Navbar=()=>{
  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px36 py-5'>
      <Link to='/' className='max-md:flex1'>
      ...
      background-blur bg-black/70 md:bg-white/10 md:border 
